    ...
    theme: DarkDashboard({
      ...
      index: {
        ...
        feeds: {
          ...
          footer:
            "<a href='https://ko-fi.com/E1E057WWV' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://cdn.ko-fi.com/cdn/kofi3.png?v=3' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a>",
        },
        information: {
          category: 'Comfi - The Aesthetic Multipurpose Bot',
          title: 'Information',
          ...
          footer:
            '<a href="https://discord.gg/HNfhvCeR6d"> ↠ Click here to join my Support Server</a>',
        },
      },
      guilds: {
        cardTitle: 'Guilds',
    ...
    settings: [
      {
        ...
        categoryOptionsList: [
          ...
          },
          {
            ...
            optionDescription:
              "Report Comfi's Bugs (make sure to include screenshots as well)",
        ...
        categoryOptionsList: [
          ...
          },
          {
            ...
            setNew: async ({ guild, newData }) => {
              ...
              if (!Time) {
                return {
                  error: 'Provide a valid time in d, h, m, s, ms format',
                };
              }
        ...
        categoryOptionsList: [
          ...
          },
          {
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (wel.welcome_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Welcome Embed Toggle is enabled,  turn it off to send non - embed message',
                };
              }
          ...
          },
          {
            ...
            optionType: DBD.formTypes.embedBuilder({
              ...
              avatarURL: bot.user.displayAvatarURL({ dynamic: true }),
              defaultJson: {
                content: '',
                embed: { title: '', color: bot.color },
              },
            }),
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (!wel.welcome_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Welcome Embed Toggle is disabled,  turn it on to send an embed',
                };
              }
        ...
        categoryOptionsList: [
          ...
          },
          {
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (leave.leave_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Leave Embed Toggle is enabled,  turn it off to send non - embed message',
                };
              }
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (!leave.leave_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Leave Embed Toggle is disabled,  turn it on to send an embed',
                };
              }
        ...
        categoryOptionsList: [
          ...
          },
          {
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (bst.boost_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Boost Embed Toggle is enabled,  turn it off to send non - embed message',
                };
              }
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (!bst.boost_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Boost Embed Toggle is disabled,  turn it on to send an embed',
                };
              }
        ...
        categoryOptionsList: [
          ...
          },
          {
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (lvl.leveling_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Leveling Embed Toggle is enabled,  turn it off to send non - embed message',
                };
              }
            ...
            allowedCheck: async ({ guild, user }) => {
              ...
              if (!lvl.leveling_embedtgl) {
                return {
                  allowed: false,
                  errorMessage:
                    'Leveling Embed Toggle is disabled,  turn it on to send an embed',
                };
              }
