  ...
  run: async (bot, interaction, args) => {
    try {
      ...
      const animeDetails = await axios
        ...
        .catch(async (err) => await bot.errorEmbed(bot, interaction, 'Unable to trace this image'));
      const Embed = new EmbedBuilder()
        ...
        .addFields(
          { name: 'Traced Image/Video', value: `EP. ${animeResult.episode} [Video Clip](${animeResult.video}) | [Image](${animeResult.image})`, inline: true },
