...
module.exports = {
  ...
  run: async (bot, interaction, args) => {
    ...
    if (sub === 'edit_author') {
      ...
      if ((!text && !icon) || !link) (data.author.name = null), (data.author.iconURL = null);
    ...
    if (sub === 'edit_footer') {
      ...
      if ((!text && !icon) || !link) (data.footer.text = null), (data.footer.iconURL = null);
    ...
    if (sub === 'show') {
      ...
      embed_new.setColor(resolveColor(embed.color));
      console.log(embed, embed_new);
