...
module.exports = {
	config: {
		name: 'reply',
		category: 'admin',
		description: "Replies to the suggestion given by the user",
		usage: 'reply <message-id> <reply>',
		example: 'reply ',
		aliases: ['s-reply']
	},
...
if (channel === null) return;
    ...
    const number = new MessageEmbed()
      .setDescription(`<:no_HE:778611410539905044>   | I don't think that was a Message ID!`)
      .setColor("FF2052")
      
    const id = new MessageEmbed()
      .setDescription(`<:no_HE:778611410539905044> |You forgot to specify Message ID!`)
      .setColor("FF2052")
      
    const query = new MessageEmbed()
      .setDescription(`<:no_HE:778611410539905044>  | You forgot to specify the Reply!`)
      .setColor("FF2052")
      
    const reply = new MessageEmbed()
      .setDescription(`<:yes_HE:778611379560120320>  | Successfully Replied the Suggestion.`)
      .setColor("F4B3CA")
      
    const noChannel = new MessageEmbed()
      .setDescription(`<:no_HE:778611410539905044>  | No Suggestion Channel found!`)
      .setColor("FF2052")
      
    const noMessage = new MessageEmbed()
      .setDescription(`<:no_HE:778611410539905044>  | Didn't find any Message with that ID!`)
      .setColor("FF2052")
