...
/**
 * Schema definition for guild data.
 *
 * Defines the MongoDB schema for storing guild (server) configuration data.
 * Includes settings for various features like welcome messages, chatbot, etc.
 */
