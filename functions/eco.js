...
class SimplyEco {
  ...
  SetWeekly({ Amt } = { Amt: 0 }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let globalData = yield global_shop_1.default.findOne({
        Id: this.Client.user.id,
      });
      if (!globalData) {
        let Add = new global_shop_1.default({
  ...
  Transfer(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let User1Data = yield global_users_1.default.findOne({
        userID: User1ID,
      });
      let User2Data = yield global_users_1.default.findOne({
        userID: User2ID,
      });
      ...
      if (!User1Data) {
        let AddUser = new global_users_1.default({
          userID: User1ID,
        });
        yield AddUser.save();
        return {
  ...
  RemoveItem({ Item } = { GuildID: null, Item: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        let Global = yield global_shop_1.default.findOne({
          Id: this.Client.user.id,
        });
        if (!Global) {
          return {
  ...
  AddItem(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!Use)
        throw new TypeError("A Use (A Use or NonUsable) must be specified");
      let Global = yield global_shop_1.default.findOne({
        Id: this.Client.user.id,
      });
      if (this.options.global === true) {
        if (!Global) {
          let Add2 = new global_shop_1.default({
  ...
  BuyItem({ UserID, Item } = { Item: null, UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        let item1 = Global.shopItems.find((item) => _checkItem(item, Item));

        let UserData = yield global_users_1.default.findOne({
          userID: UserID,
        });
        if (!item1.Name) {
          return {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!UserData) {
        ...
        return {
          ...
          description: `Successfully transferred ${this.currency} ${AMT} to your wallet as your Daily Reward`,
        };
      }
      ...
      if (daily !== null && timeout - (Date.now() - daily.getTime()) > 0) {
        ...
        return {
          ...
          description: `You have already claimed your daily reward. Wait for ${_msToTime(
            time
          )} to claim again`,
        };
      } else {
  ...
  Weekly({ UserID } = { UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let GuildData = yield global_shop_1.default.findOne({
        Id: this.Client.user.id,
      });
      let AMT;
      if (!GuildData) {
      ...
      if (!UserData) {
        ...
        yield AddUser.save();
        const time =
          timeout - (Date.now() - UserData.lastUsedWeekly.getTime()) > 0;
        return {
          status: "success",
          value: "Reward Claiming Successful",
          description: `Successfully transferred ${
            this.currency
          } ${AMT} to your wallet as your Weekly Reward. Claim again in ${_msToTime(
            time
          )}`,
        };
      }
      ...
      if (weekly !== null && timeout - (Date.now() - weekly.getTime()) > 0) {
        const time = timeout - (Date.now() - weekly.getTime()) > 0;
        return {
          status: "error",
          value: "Already Claimed",
          description: `You have successfully claimed your weekly reward. Wait for ${_msToTime(
            time
          )} to claim again`,
        };
      } else {
  ...
  GetInv({ UserID } = { UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      if (!UserID) throw new TypeError("A user ID must be specified");
      let User = yield global_users_1.default.findOne({
        userID: UserID,
      });
      if (!User) {
        let AddUser = new global_users_1.default({
  ...
  GetUser({ UserID } = { UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!User) {
        let AddUser = new users_1.default({
          userID: UserID,
        });
        yield AddUser.save();
        return AddUser;
  ...
  GetBal({ UserID } = { UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      if (!UserID) throw new TypeError("A member ID must be specified");
      let Bal = yield global_users_1.default.findOne({
        userID: UserID,
      });
      if (!Bal) {
        let AddUser = new global_users_1.default({
  ...
  GetShop({ GuildID } = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        ...
        let Gshop = yield global_shop_1.default.findOne({
          Id: this.Client.user.id,
        });
        if (!Gshop) {
          let Ggshop = new global_shop_1.default({
            Id: this.Client.user.id,
          });
          yield Ggshop.save();
          if (!Ggshop.shopItems) {
  ...
  ReassignJob({ UserID, Job } = { Job: null, UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let job = jobs_js_1.default.find(
  ...
  RemoveJob({ UserID } = { UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let current = user === null || user === void 0 ? void 0 : user.job;
      if (!current) {
        return {
          status: "error",
          value: "Not Working",
  ...
  SetJob({ UserID, Job } = { Job: null, UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let job = jobs_js_1.default.find((job) => job.Name.toLocaleLowerCase() === Job.toLocaleLowerCase());
      let current = user.job;
      let leftJob = user.jobLeft;
