...
class SimplyEco {
      ...
      if (!UserData) {
        ...
        return {
          ...
          description: `Successfully transferred ${
            this.currency
          } ${AMT} to your wallet as your Daily Reward. Claim again in __**${_msToTime(
            time
          )}**__`,
        };
      }
  ...
  SetJob({ UserID, Job } = { Job: null, UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (leftJob !== null && timeout - (Date.now() - leftJob?.getTime()) > 0) {
  ...
  Work({ UserID } = { UserID: null }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const jobs = jobs_js_1.default.find(
        (job) =>
          job.Name.toLocaleLowerCase() === UserData.job.toLocaleLowerCase()
      );
...
const _checkItem = (item, testableItemIdOrName) =>
  item.Name == testableItemIdOrName || item.id == testableItemIdOrName;
