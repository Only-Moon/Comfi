    ...
    if(interaction.isSelectMenu()) {
        ...
        if(guild.dropdownRoles.length > 0) {
            if(interaction.customId === "dropdown_roles") {
                if(!interaction.guild.me.permissions.has("MANAGE_ROLES")) return interaction.reply({content: `${bot.crosss} • I am missing the required permissions to give you these roles!`})
