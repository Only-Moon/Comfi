  ...
  if (interaction.isButton()) {
    ...
    if (guild.ticket) {
      ...
      simplydjs.manageTicket(interaction, {
          ...
          buttons: {
            close: { style: ButtonStyle.Secondary, emoji: '796196175627419678' },
            reopen: { style: ButtonStyle.Secondary, emoji: '855791964975530004' },
            delete: { style: ButtonStyle.Secondary, emoji: '796196175627419678' },
            transcript: { style: ButtonStyle.Secondary, emoji: '905055261021061150' },
        },
      }).then((log) => {
